class BladewindNotification {
    ...
    show = () => {
        ...
        domEl(".bw-notification-container").insertAdjacentHTML(
            "beforeend",
            this.template(),
        );
    ...
    setContainerSize = () => {
        changeCss(
            ...
            this.sizes[this.size].container,
            "add",
        );
    };
    ...
    modalIcon = () => {
        changeCss(
            `.bw-notification-icons .${this.type}`,
            this.sizes[this.size].modal_icon,
            "add",
        );
        changeCss(`.bw-notification-icons .${this.type}`, "hidden", "remove");
        return domEl(
            `.bw-notification-icons .${this.type}`,
        ).outerHTML.replaceAll("[type]", this.typeColour(this.type));
    };
