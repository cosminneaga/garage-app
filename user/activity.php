...
?>
    ...
    <body class="bg-info m-0">
        <?php define('nav', TRUE); require('nav.php'); ?>
            ...
            <div class="row"  id="button-area">
                <div class="col-sm-12 p-2 d-flex justify-content-center">
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-secondary" onclick="iframes(this.id)" id="clients">Clients</button>
                        <button type="button" class="btn btn-secondary" onclick="iframes(this.id)" id="bookings">Bookings</button>
                        <button type="button" class="btn btn-secondary" onclick="iframes(this.id)" id="invoices">Invoices</button>
                        <button type="button" class="btn btn-secondary" onclick="iframes(this.id)" id="vehicles">Vehicles</button>
                    </div>
                </div>
            </div>
