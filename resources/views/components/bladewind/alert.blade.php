...
@php
    ...
    $presets = in_array($type, ['error', 'warning', 'info', 'success'])
        ? [
            ...
            'icon' => [
                'faint' => "text-$alternate_colour-600",
                'dark' => "!text-$alternate_colour-50",
            ],
        ]
        : [
...
<div
    class="w-full bw-alert animate__animated animate__fadeIn rounded-md flex p-3  {{ $colours[$shade] }} {{ $class }}"
    {{ $attributes }}
>
    @if ($showIcon)
        <div class="pt-[1px]">
