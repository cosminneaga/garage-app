...
enum UserRole: string
{
    ...
    {
        return match ($this) {
            self::ADMIN_SUPER => 'App Administrator',
            self::USER_MANAGER => 'User Administrator over it\'s own companies, users, vehicles, clients, invoices',
